...
g++ -std=c++17 -Wall -Wextra ^
    src\main.cpp ^
    src\core\Game.cpp src\core\Player.cpp ^
    src\systems\InputManager.cpp src\systems\World.cpp^
    src\entities\Unit.cpp src\entities\Building.cpp ^
    src\core\Camera.cpp src\core\EntityManager.cpp ^
    src\ui\HUD.cpp  ^
